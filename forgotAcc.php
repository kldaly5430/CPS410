...
<html>
	...
	<body>
		...
		<!--Body of page -->
		<!-- Create container the width of the webpage -->
		<div class="container-fluid">
			<div class="row">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12">
									<p>Enter Email address of Account</p>
									<div class="form-group">
										<label class="sr-only" for="exampleInputEmail2">Email address</label>
										<!-- Email is required. Place email placeholder in textbox -->
			...
			<div class="container">
				<div class="row">
					...
					<div class="col col-lg-2">
						<!-- Creates clickeable icon links to social media platforms. Currently unlinked. -->
						<h3>Contact Us</h3>
