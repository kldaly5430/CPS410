							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12">
									<div class="form-group">
										<p>An confirmation email will be sent to your email shortly. Your recipt will also be attached to the email. Click the button below to be returned to the home page.</p>
									</div>
								</div>
							</div>
							<div class="row">
